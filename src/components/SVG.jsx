    ...
    return (
        <svg className={"w-[300px] lg:w-[709px]"} xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
                ...
                <filter id="c" width="103.2%" height="147.9%" x="-1.6%" y="-24%"
                        filterUnits="objectBoundingBox">
                    <feOffset in="SourceAlpha" result="shadowOffsetOuter1"/>
                    <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1"
                                    stdDeviation="3.5"/>
                ...
                <filter id="h" width="108.2%" height="105.1%" x="-4.1%" y="-2.6%"
                        filterUnits="objectBoundingBox">
                    <feOffset in="SourceAlpha" result="shadowOffsetOuter1"/>
                    <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1"
                                    stdDeviation="3"/>
                ...
                <filter id="j" width="108.2%" height="148.1%" x="-4.1%" y="-24.1%"
                        filterUnits="objectBoundingBox">
                    <feOffset in="SourceAlpha" result="shadowOffsetOuter1"/>
                    <feGaussianBlur in="shadowOffsetOuter1" result="shadowBlurOuter1"
                                    stdDeviation="3"/>
                ...
                <linearGradient id="e" x1="14.811%" x2="75.996%" y1="-22.362%" y2="119.406%">
            ...
            <g fill="none" fillRule="evenodd">
                <g transform="translate(7 7)">
                    ...
                    <rect width="137.008" height="16.433" x="49.323" y="13.694" fill="#E1E8EE"
                          rx="3.425"/>
                    ...
                    <g transform="translate(49.323 94.492)">
                        <ellipse cx="32.882" cy="32.867" fill="url(#e)" rx="32.882" ry="32.867"/>
                    ...
                    <g transform="translate(49.323 187.614)">
                        <ellipse cx="30.827" cy="30.813" fill="url(#f)" rx="30.827" ry="30.813"/>
                    ...
                    <g transform="translate(49.323 285.53)">
                        <ellipse cx="30.827" cy="30.813" fill="url(#g)" rx="30.827" ry="30.813"/>
                        <g fill="#E1E8EE" transform="translate(102.07 6.162)">
                            <rect width="78.78" height="10.956" rx="2.055"/>
                            <rect width="274.016" height="5.478" y="21.911" rx="2.055"/>
                            <rect width="251.181" height="5.478" y="32.867" rx="2.055"/>
                ...
                <g transform="translate(505.709 223.372)">
                    <ellipse cx="10.276" cy="10.271" fill="url(#e)" rx="10.276" ry="10.271"/>
                    <g fill="#E1E8EE" transform="translate(31.512 2.054)">
                        <rect width="39.39" height="3.652" rx=".63"/>
                        <rect width="137.008" height="1.826" y="7.304" rx=".63"/>
                        <rect width="125.591" height="1.826" y="10.956" rx=".63"/>
                        <rect width="114.173" height="1.826" y="14.607" rx=".63"/>
                    </g>
                </g>
                ...
                <g transform="translate(505.709 254.87)">
                    ...
                    <ellipse cx="10.276" cy="10.271" fill="url(#f)" rx="10.276" ry="10.271"/>
                </g>
                ...
                <g transform="translate(505.709 286.367)">
                    ...
                    <ellipse cx="10.276" cy="10.271" fill="url(#g)" rx="10.276" ry="10.271"/>
                </g>
